...
export function MealSuggestionPanel() {
  ...
  return (
    <section className="mb-6 space-y-4 rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
      <div>
        <div>
          <h2 className="text-lg font-semibold text-zinc-900">Atlas meal chat</h2>
      ...
      <div className="space-y-3">
        {messages.length === 0 && isSuggesting ? (
          <p className="rounded-lg bg-zinc-50 px-4 py-3 text-sm text-zinc-700">Atlas is checking today&apos;s meals, workouts, and calendar...</p>
        ) : null}
